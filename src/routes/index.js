...
router.get('/academic-calendar', pagesController.renderAcademicCalendar);
router.get('/code-of-conduct', pagesController.renderCodeOfConduct);
router.get('/privacy-policy', pagesController.renderPrivacyPolicy);
router.get('/terms-of-use', pagesController.renderTermsOfUse);
router.get('/sitemap', pagesController.renderSitemapPage);
...
router.get('/api/academic-calendar', pagesController.getAcademicCalendarAPI);
router.post('/api/academic-calendar', pagesController.addAcademicCalendarAPI);
router.delete('/api/academic-calendar/:id', pagesController.deleteAcademicCalendarAPI);
...
router.get('/api/admission-banner', pagesController.getAdmissionBanner);
router.post('/api/admission-banner', pagesController.saveAdmissionBanner);
