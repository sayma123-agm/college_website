...
const mockFaculty = [
    { name: 'Dr. S. V. Shiragur', designation: 'Professor & Head', qualification: 'Ph.D in CSE', experience: '18 Years', researchArea: 'Wireless Networks & Distributed Systems', email: 'hod.cse@agmrcet.ac.in', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=300&q=80', department_id: 'cse' },
    ...
    { name: 'Dr. Mahesh M. G.', designation: 'Professor & Head', qualification: 'Ph.D in Machine Learning', experience: '15 Years', researchArea: 'Deep Learning & Natural Language Processing', email: 'hod.aiml@agmrcet.ac.in', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=300&q=80', department_id: 'cse-aiml' },
    ...
    { name: 'Prof. Shruti Patil', designation: 'Assistant Professor & Head', qualification: 'M.Tech in CSE', experience: '10 Years', researchArea: 'Human Computer Interaction, UI/UX Design', email: 'hod.csd@agmrcet.ac.in', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&q=80', department_id: 'csd' },
    ...
    { name: 'Dr. Santosh R. P.', designation: 'Professor & Head', qualification: 'Ph.D in VLSI Design', experience: '17 Years', researchArea: 'Micro-electronics & VLSI Signal Processing', email: 'hod.ece@agmrcet.ac.in', image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=300&q=80', department_id: 'ece' },
    ...
    { name: 'Prof. Kiran K.', designation: 'Associate Professor & Head', qualification: 'M.Tech, (Ph.D)', experience: '12 Years', researchArea: 'Electric Vehicle Powertrains & Battery Tech', email: 'hod.eee@agmrcet.ac.in', image: 'https://images.unsplash.com/photo-1628157582853-a796fa650a6a?auto=format&fit=crop&w=300&q=80', department_id: 'eee' },
    ...
    { name: 'Prof. S. R. Patil', designation: 'Associate Professor & Head', qualification: 'M.Tech in Structural Engineering', experience: '14 Years', researchArea: 'Sustainable Construction Materials & Earthquake Eng.', email: 'hod.civil@agmrcet.ac.in', image: 'https://images.unsplash.com/photo-1598550874175-4d0ef436c909?auto=format&fit=crop&w=300&q=80', department_id: 'ce' },
